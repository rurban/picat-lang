...
\item \texttt{solve\_all($Options$, $Vars$) = $Solutions$}\index{\texttt{solve\_all/2}}: This function returns all the solutions that satisfy the constraints.\footnote{The \texttt{solve\_all} function is not available in the \texttt{mip} module.}
